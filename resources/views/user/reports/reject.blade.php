                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="container text-center">
                            <form action="{{ route('user.report.reject') }}" method='get' class="row">
                                {{-- <div class="col-4">
                                ...
                                <div class="col-1">
                                    <a class="btn btn-danger m-btn m-btn--air m-btn--custom" href="{{ route('user.report.reject') }}"><i class="fa fa-times"></i></a>
                                </div>
                            </form>
                        </div>
                        @php
