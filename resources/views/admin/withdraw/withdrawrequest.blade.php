                                            ...
                                            @foreach ($withdraw as $withdraw)
                                                <tr>
                                                    ...
                                                    <td>{{$withdraw?->withdraw_amount}}</td>
                                                     <td>{{$withdraw?->tax}}</td>
                                                    <td>{{ $withdraw?->note }}</td>
                                                    <td>@if($withdraw->status == 0) <button type="submit" data-user_id="{{$withdraw?->id}}" id="userWithdrawRequest" class="btn btn-primary userWithdrawRequest">Pending</button>@endif</td>
