        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"> Reject Report</h4>
                            <p class="card-description">

                            </p>
                            <form action="{{ route('admin.report.reject') }}" method='get' class="row">
                                <div class="col-4">
                                ...
                                <div class="col-1">
                                    <a class="btn btn-danger m-btn m-btn--air m-btn--custom" href="{{ route('admin.report.reject') }}"><i class="fa fa-times"></i></a>
                                </div>
                            </form>
